...
import 'package:scan/dmrtd_lib/extensions.dart';
import 'package:scan/dmrtd_lib/src/com/com_provider.dart';
...
class NfcProvider extends ComProvider {
  ...
  Duration timeout = const Duration(seconds: 60); /// [Android] Default timeout.
  ...
  Future<void> connect({Duration? timeout, String iosAlertMessage = "Hold your iPhone near the biometric Passport"}) async {
    ...
    try {
      ...
      print('nrrrrrrrrrrrrrrrrrrrrrr $e');
